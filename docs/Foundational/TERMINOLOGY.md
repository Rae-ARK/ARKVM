...
| Term | Meaning | Source |
| --- | --- | --- |
| **Rei (language)** | The planned native source language for ARKlight. Say "the Rei language" wherever confusion is possible. | `Proposal/REI-LANGUAGE-PROPOSAL.md`, open question 7 |
